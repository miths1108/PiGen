...
public class ConditionBaseAggregate extends ConditionBase implements ConditionAggregate {
	...
	public ConditionBaseAggregate(String relname, String alias, String predicate, long outputCardinality, List<String> groupKey, Set<String> groupTables, long projectionCardinality, boolean isTop) {
		super(relname, alias, predicate, outputCardinality);
