...
public class FormalConditionSimpleNumberAggregate extends FormalConditionSimpleNumber implements FormalConditionAggregate {
	...
	public FormalConditionSimpleNumberAggregate(ConditionAggregate origCondition, FormalConditionSimpleNumber formalConditionSimpleNumber) {
		super(formalConditionSimpleNumber);
	...
	public FormalConditionSimpleNumberAggregate(String columnname, String symbolString, String valueStr) {
		super(columnname, symbolString, valueStr);
	}
...
//        return result;
    ...
    @Override
    public FormalConditionSimpleNumberAggregate getDeepCopy() {
    	FormalConditionSimpleNumberAggregate another = new FormalConditionSimpleNumberAggregate(columnname, symbol.symbolString, String.valueOf(value));
